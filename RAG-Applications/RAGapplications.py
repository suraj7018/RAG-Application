...
with st.sidebar:
    ...
    api_mode = st.selectbox("Choose the API Interface", ["Choose an API", "NVIDIA API", "GROQ API"])
    api_key = ""
...
if api_mode == "Choose an API" or not api_key:
    ...
    if app_mode == "Chat with PDF":
        ...
        st.write(
            "Start interacting with your PDF documents in a chat format. "
            "Upload a PDF and ask questions or extract information effortlessly."
        )
                    ...
                    with st.spinner("Processing..."):
                        if "youtube.com" in generic_url:
                            ...
                            loader = UnstructuredURLLoader(
                                urls=[generic_url], headers=headers, ssl_verify=False
                            )
